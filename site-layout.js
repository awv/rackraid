   ...
   // 1. Inject Global Header
    ...
    if (headerCanvas) {
        headerCanvas.innerHTML = `
            ...
            <header class="w-full bg-slate-900 text-white shadow-md border-b border-slate-800/50">
                <!-- Max-width content alignment container -->
                <div class="max-w-[1400px] mx-auto px-4 min-h-[70px] py-3 flex flex-wrap justify-between items-center gap-4 relative">
